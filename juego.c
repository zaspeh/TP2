...
void introduccion()
{
    ...
    -Las letras S y R significan Stitch y Reuben respectivamente.\n \
    -Es importante que le prestes atencion a los dialogos del juego ya que te van a ir actualizando lo que pasa en el momento estos van a aparecer arriba de la matriz una vez que hayas realizado un movimiento.\n \
    -Es recomendable jugarlo en la resolucion 80x24 del compilador.\n \
    -TEN CUIDADO, depende lo que respondas en el cuestionario va a afectar a la cantidad de niveles que va a tener el juego.\n \
